...
[myF, names, valNames] = ConvertNetwork('/Users/janechen/Desktop/¿Î³Ì/PGM/_72bd6a1dc11c629792246b715f627ffe_PA-Simple-BN-Knowledge-Engineering-Release/Credit_net.net');
...
% Factor Product
FACTORS.PRODUCT = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(1));
P321 = FactorProduct(FACTORS.INPUT(2), FACTORS.INPUT(3));
P321_ = FactorProduct(P321, FACTORS.INPUT(1));
...
P21 = FactorMarginalization(P321, [3]);
P12 = FactorMarginalization(P321_, [3]);
P1 = FactorMarginalization(P12, [2]);
