...
for i = 1:prod(phenotypeFactor.card)
    genotypeIndex = allelesToGenotypes(assignments(i,2), assignments(i,3));
    phenotypeFactor.val(i) = abs(assignments(i,1)-1-alphaList(genotypeIndex));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%