...
for i = 1:prod(genotypeFactor.card)
    p1 = genotypesToAlleles(assignments(i,2),:);
    p2 = genotypesToAlleles(assignments(i,3),:);
    c = genotypesToAlleles(assignments(i,1),:);
    %if((ismember(c(1),p1)&&ismember(c(2),p2))||)
    genotypeFactor.val(i) = 0.25*(all([p1(1),p2(1)]==c)||all([p2(1),p1(1)]==c))+0.25*(all([p1(1),p2(2)]==c)||all([p2(2),p1(1)]==c))+0.25*(all([p1(2),p2(1)]==c)||all([p2(1),p1(2)]==c))+0.25*(all([p1(2),p2(2)]==c)||all([p2(2),p1(2)]==c));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%