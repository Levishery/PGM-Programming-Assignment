...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
log_prop = LogProbOfJointAssignment(F, A_prop);
log_orig = LogProbOfJointAssignment(F, A);
p_acceptance = log_prop - log_orig + log_QY_ratio + LogR(old_value) - LogR(new_value);
p_acceptance = min(exp(p_acceptance),1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
